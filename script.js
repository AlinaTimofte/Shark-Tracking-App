const sharks = [
    {
        tag: "Tracking",
        name: "Deep Blue",
        description: "Is a female greate white shark that is estimated to be 6.1m long or larger and is now 60 years old. She is believed to be one of the largest ever recorded in history.",
        length: "6.1m",
        weight: "2000kg",
        zone: "Pacific",
